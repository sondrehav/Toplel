...
public class Packet {
    ...
    // General messages from oldold.server to client (0 -> 31):
    ...
    // Requests from oldold.server to client (32 -> 95):
    public static final byte REQ_VERSION = 32;
    public static final byte REQ_FILE_TABLE = 33;

    // Response from oldold.server to client (96 -> 127):
    ...
    // General messages from client to oldold.server (-128 -> -97):
    public static final byte CL_DISCONNECT = -128;
    public static final byte CL_MESSAGE = -127;

    // Request from client to oldold.server (-96 -> -33):
    public static final byte REQ_SET_USERNAME = -96;

    // Response from client to oldold.server (-32 -> -1):
