package oldold.old.main;

import oldold.math.MyMat3;
import oldold.old.entities.particles.ParticleEmitter;
import oldold.old.utils.camera.Camera;
...
public class Main {
    ...
    private static MyMat3 projMat;
    private static MyMat3 viewMat;
    ...
    Main(){
        ...
        projMat = MyMat3.projection((float) width, (float) height);
        viewMat = new MyMat3();
...
//        Tile grass = new Tile("res/img/oldold.game/tiles/grass_a.png", new Vector2f(0f,0f), new Vector2f(10f,10f), 0f);
//        Tile dirt = new Tile("res/img/oldold.game/tiles/dirt_a.png", new Vector2f(-10f,0f), new Vector2f(10f,10f), 0f);
