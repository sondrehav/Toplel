package oldold.old.entities.particles;

import oldold.old.entities.Entity;
...
//        try{
////            this.fireTexture = MyTextureLoader.load("res/img/oldold.game/entities/particles/fire.png");
////            this.smokeTexture = MyTextureLoader.load("res/img/oldold.game/entities/particles/smoke.png");
